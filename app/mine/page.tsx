          ...
          <div className="profile-mobile__identity-main">
            ...
            <div className="profile-mobile__identity-meta">
              ...
              <div className="profile-mobile__identity-row">
                ...
                <span className="profile-mobile__identity-value">{profile.coopId}</span>
              </div>
            </div>
          </div>
          ...
          <div className="profile-mobile__menu-list">
            ...
            >
              ...
              <div className="profile-mobile__menu-copy">
                ...
                <p>Update your profile photo and identity details</p>
              </div>
              <span className="profile-mobile__menu-caret">›</span>
            </button>
          </div>
      ...
      >
        <header className="profile-edit__header">
          <div>
            ...
            <p>Update your avatar, nickname and cooperative ID in one place.</p>
          </div>
        ...
        <form className="profile-edit__form" onSubmit={handleSubmit}>
          ...
          <div className="profile-edit__field">
            ...
            <div className="profile-edit__photo-row">
              <input
                id="profile-photo"
                type="file"
                accept="image/*"
              ...
              />
              {photo && (
                <button type="button" className="profile-edit__remove" onClick={() => setPhoto(null)}>
                  Remove photo
                </button>
              )}
            </div>
