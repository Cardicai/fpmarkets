          ...
          <header className="border-white/10 bg-slate-950/80 backdrop-blur-sm border-b">
            <div className="mx-auto flex max-w-6xl items-center justify-between gap-6 px-4 py-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  href="/auth"
                  className="hidden rounded-full bg-gradient-to-r from-cyan-400 via-sky-400 to-emerald-400 px-5 py-2 text-sm font-semibold text-slate-950 shadow-lg transition hover:from-cyan-300 hover:to-emerald-300 md:inline-flex"
                >
                  Partner sign in
                </Link>
              </div>
